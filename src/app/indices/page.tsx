          ...
          <div className="max-w-4xl mx-auto">
            <div className="auth-header mb-8">
              ...
              <p className="auth-subtitle">
                Auto-invest in the crypto market with diversified index funds.
              </p>
            </div>
                ...
                {[1, 2].map((item) => (
                  <div key={item} className="bp-card p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-3">
                        <h3 className="font-medium text-gray-900">Bitpanda Crypto Index</h3>
                        <p className="text-sm text-gray-500">BCI</p>
                      </div>
                    </div>
                    <div className="mb-4">
